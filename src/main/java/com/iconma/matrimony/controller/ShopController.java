package com.iconma.matrimony.controller;
...
import com.iconma.matrimony.service.ShopService;
import com.iconma.matrimony.validation.ShopValidator;
...
public class ShopController {
	...
	public ModelAndView sendMsg(@PathVariable String msg,
			final RedirectAttributes redirectAttributes) throws ShopNotFound {
		//amqptemplate.convertAndSend(msg);
		ModelAndView mav = new ModelAndView("redirect:/index.html");		
		redirectAttributes.addFlashAttribute("message","Message : "+ msg+"Send Successfully");
		return mav;
	}
	
	@RequestMapping(value="/recv", method=RequestMethod.GET)
	public ModelAndView recvMsg(final RedirectAttributes redirectAttributes) throws ShopNotFound {
		ModelAndView mav = new ModelAndView("redirect:/index.html");		
